...
using OpenDesk.Infrastructure.Data.BinarySerializer;
using OpenDesk.Infrastructure.Settings;

namespace OpenDesk.Infrastructure.Data.Text
{
    public class TextFileWorkspace : IWorkspace, IReadOnlyWorkspace
    {
        ...
        {
            return Path.GetDirectoryName(Assembly.GetCallingAssembly().Location) + "\\OpenDeskDB.txt";
        }
