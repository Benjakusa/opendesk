...
using OpenDesk.Infrastructure.Data.SQL;
using OpenDesk.Infrastructure.Data.Text;
using OpenDesk.Infrastructure.Settings;

namespace OpenDesk.Persistance.Data
{
        ...
        private static void Migrate(CommonDbContext context)
        {
            ...
            IRunnerContext migrationContext =
                new RunnerContext(announcer)
                {
                    ...
                    Database = db,
                    Target = LocalSettings.AppPath + "\\OpenDesk.Persistance.DbMigration.dll"
                };
