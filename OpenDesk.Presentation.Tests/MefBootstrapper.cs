...
namespace OpenDesk.Presentation.Tests
{
    ...
    public static class MefBootstrapper
    {
        ...
        static MefBootstrapper()
        {
            ...
            catalog.Catalogs.Add(new DirectoryCatalog(path, "OpenDesk.Persistance.dll"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "OpenDesk.Presentation*"));
            catalog.Catalogs.Add(new DirectoryCatalog(path, "OpenDesk.Services*"));
