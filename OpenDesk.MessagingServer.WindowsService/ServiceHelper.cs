...
namespace OpenDesk.MessagingServer.WindowsService
{
    public static class ServiceHelper
    {
        private static readonly string _installAssembly = "OpenDesk.MessagingServer.WindowsService.exe";
        private static readonly string _logFile = "WindowsServiceInstall.log";
        private static readonly string _serviceName = "OpenDesk3-MessagingServer";
